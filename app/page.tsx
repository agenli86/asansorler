...
export const metadata: Metadata = {
  ...
  description: 'Adana asansör kiralama hizmeti. Ev taşıma asansörü, mobil asansör kiralama, eşya taşıma asansörü kiralama, asansörlü nakliye ve nakliye asansörü ile Adana\'da profesyonel taşımacılık çözümleri.',
  openGraph: {
    title: 'Adana Asansör Kiralama | Kiralık Asansör, Ev Taşıma Asansörü, Mobil Asansör',
    description: 'Adana asansör kiralama hizmeti. Ev taşıma asansörü, mobil asansör kiralama ve asansörlü nakliye ile profesyonel taşımacılık.',
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="section-subtitle">Adana'da her türlü taşıma ihtiyacınız için profesyonel asansör kiralama çözümleri sunuyoruz.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="section-subtitle">Asansör kiralama ve taşımacılık hakkında faydalı bilgiler edinin.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {blogPosts.map((post, index) => (
              <div key={index} className="card group">
                ...
                <div className="p-6">
                  ...
                  <Link href={`/blog/${post.slug}`} className="text-primary-600 font-semibold hover:text-primary-700 inline-flex items-center gap-1">
                    Devamını Oku
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
      ...
      <section className="py-20 gradient-bg hero-pattern relative">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Adana'da asansör kiralama ihtiyacınız için 7/24 hizmetinizdeyiz. Profesyonel ekibimizle tanışın.
          </p>
